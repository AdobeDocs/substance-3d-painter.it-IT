...
Nella parte superiore sinistra della finestra della vista potrebbe essere visualizzato un testo che indica il profilo caricato. Per ulteriori informazioni, consulta la pagina [Profilo colore](../../features/post-processing/color-profile.md).
...
In basso a destra nella finestra della vista si trova l’asse della vista 3D che indica l’orientamento della scena rispetto alla videocamera.

## Impostazioni aggiuntive

La visualizzazione della finestra della vista può essere influenzata da altre impostazioni:

* [Impostazioni shader](../shader-settings/shader-settings.md)
