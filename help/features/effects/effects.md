...
>[!NOTE]
>
> Potete fare clic con il pulsante destro del mouse su un effetto per riordinarlo, ma potete anche utilizzare i tasti ALT+freccia SU o freccia GIÙ per riordinarli rapidamente.

Questi sono i diversi tipi di effetti che troverai in Substance 3D Painter:

* [Generatore](generator.md)
* [Dipingi](paint.md)
* [Riempimento](fill.md)
* [Livelli](levels.md)
* [Confronta la maschera](compare-mask.md)
* [Filtro](filter.md)
* [Punto di ancoraggio](anchor-point.md)
