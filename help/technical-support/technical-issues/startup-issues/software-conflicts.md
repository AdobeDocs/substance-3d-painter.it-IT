...
Questa pagina contiene un elenco di problemi noti relativi ad altri software che potrebbero causare l&#39;arresto anomalo o l&#39;interruzione corretta dell&#39;esecuzione di Substance 3D Painter.
...
| **AMD CrossFire e NVIDIA SLI** | Painter non supporta più configurazioni GPU, con conseguente arresto anomalo. Si consiglia di disabilitare questa funzione. |
| <b> Assistente Autodesk </b> | L&#39;applicazione Autodesk Assistant può creare conflitti e causare l&#39;arresto anomalo dell&#39;applicazione all&#39;avvio o all&#39;apertura di un file di progetto. Aggiornare l&#39;applicazione Autodesk per risolvere il problema. |
| <b> computer Alienware/Dell</b> | Per ulteriori informazioni, consulta questa pagina: [Arresto anomalo all&#39;apertura o al salvataggio di un file](../stability-issues/crash-when-opening-or-saving-a-file.md). |
| **APFS di Paragon Software** | Questo software può registrare una posizione nella variabile di ambiente Percorso di Windows che può causare l&#39;arresto anomalo dell&#39;applicazione all&#39;avvio. La disinstallazione del software potrebbe non essere sufficiente e potrebbe essere necessario rimuovere manualmente la variabile di ambiente. Esempio di percorso problematico: `C:Program Files (x86)Paragon SoftwareAPFS for Windowsï–›éŒ à €è¸€ì‡ì‡ç¿¹` |
...
| **Software di backup cloud** **(** OneDrive,**GDrive,** **Dropbox,** **Filestream, ecc.)** | Il software di backup cloud può causare numerosi arresti anomali durante il salvataggio di un progetto. In tal caso, si consiglia di lavorare sul file di progetto e di salvarlo in una cartella non sincronizzata, copiando invece i file di progetto nuovamente nell’unità cloud una volta che le modifiche non saranno più apportate. |
| **Chitubox** | Questo software può creare un conflitto e arrestare in modo anomalo l&#39;applicazione quando si apre una finestra di dialogo di file (come l&#39;apertura o il salvataggio di un progetto). Per evitare questo problema, è possibile disattivare l&#39;impostazione <b>Abilita anteprima miniature del modello desktop</b> nelle preferenze di Chitubox. |
...
| **Google Chrome** | Google Chrome può causare arresti anomali quando viene eseguito insieme a Substance 3D Painter. Per migliorare la stabilità di Substance 3D Painter, si consiglia di aggiornare Google Chrome e i driver della GPU. Se si verificano ancora arresti anomali, disattiva Accelerazione hardware in Google Chrome (che interromperà l’utilizzo della GPU da parte di Chrome). |
| **Software audio Nahimic** | <b>Nahimic</b> può bloccare o arrestare in modo anomalo il Painter. Può essere utile interromperlo e aggiornarlo può anche evitare problemi. Nahimic esegue anche servizi in background che possono interferire con l&#39;applicazione e che potrebbero dover essere arrestati o disabilitati. |
...
| **Rptr / Plays.tv** | <b>Rptr</b> (o <b>[Plays.tv](http://plays.tv/) </b>) è installato per impostazione predefinita con alcuni driver GPU. Questo software può creare instabilità e arrestare l&#39;applicazione in modo anomalo. Si consiglia di disinstallare l’applicazione. |
