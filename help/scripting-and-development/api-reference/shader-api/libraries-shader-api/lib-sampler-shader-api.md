...
# Lib Sampler - API shader

## lib-sampler.glsl

**Funzioni pubbliche:** *getAO* *getShadowFactor* *getGlossiness* *getRoughness* *getMetallic* *getAnisotropyLevel* *getAnisotropyAngle* *getOpacity* *getHeight* *getDisplacement* *getSpecularLevel* *getBaseColor* *getDiffuse* *getSpecularColor* *getScattering* *generateAnisotropicRoughness* *generateDiffuseColor* *generateSpecularColor*
...
Colori di sfondo predefiniti in assenza di dati nel canale (alfa è 0)
...
Valore utilizzato per modificare l’intensità dell’Occlusione ambientale.
...
Restituire la rugosità campionata o un valore predefinito
...
Restituisce un valore metallico campionato o un valore predefinito
...
Restituire un valore predefinito o un valore di opacità campionato
...
Restituire un height campionato o un valore predefinito
...
Restituire uno spostamento campionato o un valore predefinito
...
Helper per ottenere l&#39;occlusione ambientale per l&#39;ombreggiatura
...
Recupera il fattore di ombreggiatura (spazio-schermo)
...
Restituire un colore di base campionato o un valore predefinito
...
Restituire un colore diffuso campionato o un valore predefinito
...
Restituire un colore di specular campionato o un valore predefinito
...
Genera rugosità anisotropica da rugosità e livello di anisotropia
...
Genera colore diffuso da colore di base e fattore metallico
...
Genera colore specular da specular level dielettrico, colore di base e fattore metallico
...
Restituisce un valore di dispersione campionato o un valore predefinito
