...
# Lib normale - API shader

## lib-normal.glsl

**Funzioni pubbliche:** *normalBlend* *normalBlendOriented* *normalFade* *normalUnpack* *normalFromBaseNormal* *normalFromNormal* *normalFromHeight* *getTSNormal* *computeWSBaseNormal* *computeWSNormal*
...
Tutti i parametri del motore utili per le operazioni incentrate sulla norma.
...
Utilizzato per invertire l&#39;asse Y della mappa normale
...
Empiricamente determinato dai nostri artisti...
...
Eseguire la fusione tra 2 mappe normali

Questo metodo è basato sulla fusione Sbianca http://blog.selfshadow.com/publications/blending-in-detail/
...
Eseguire una fusione orientata ai dettagli tra 2 mappe normali

Questa operazione si basa sulla fusione orientata ai dettagli http://blog.selfshadow.com/publications/blending-in-detail/
...
Restituisce un valore normale appiattito da un fattore di attenuazione
...
Calcola lo spazio tangente normale dal canale di height del documento
...
Helper per calcolare la normale dello spazio tangente dalla normale di base e un valore height, nonché una normale di dettaglio opzionale.
...
Helper per calcolare la normale dello spazio tangente dalla normale di base e dal height, e una normale di dettaglio opzionale.
...
Helper per calcolare la normale dello spazio globale dalla normale della base dello spazio tangente.
