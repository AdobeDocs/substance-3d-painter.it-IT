---
helpx_url: 'https://helpx.adobe.com/it/substance-3d-painter/release-notes/all-changes.html'
breadcrumb-title: ''
...
* [Strumento] L’anteprima del materiale non funziona quando si utilizza la proiezione in una maschera
* [Eseguo i baking] L’impostazione AO &quot;Occlusione autonoma&quot; viene ignorata con diversi set di texture e l’opzione &quot;corrispondenza per nome&quot; è abilitata
* [Eseguo i baking] AO con normale presenta artefatti ai bordi a causa di spaziatura interna mancante
...
* [VFX Platform 2025] Aggiungere la configurazione ACE 2.0 nelle impostazioni di gestione del colore
* [VFX Platform 2025] Aggiornamento OCIO alla versione 2.4.2
...
* [UI] Alcuni menu sono sempre disattivati dopo l’apertura di un progetto (ad esempio, simmetrie)
* [Properties] Impossibile utilizzare/caricare strumenti predefiniti con lo strumento Filled path
* [USD] Più set UV non vengono riconosciuti in uno shader personalizzato quando si utilizzano file USD
* [USD] Le videocamere con gli stessi nomi sono sostituite
...
* [Python] Impossibile allocare l&#39;errore dell&#39;elenco durante la ricerca per indicizzazione dei nodi della Pila livelli
...
* [Python] Consenti di aggiungere maschera avanzata a un livello
...
* [Modalità Eseguita i baking] Arresto anomalo quando si passa alla modalità eseguita i baking prima che il modello venga caricato
* [Modalità di Esegue i baking] Messaggio di errore mancante nella scheda Esegue i baking processo
* [Modalità di Esegue i baking] Le impostazioni del materiale neutro non hanno effetto dopo la reimportazione di una trama
* [Modalità di Esegue i baking] Il separatore della finestra della vista viene salvato globalmente e non per modalità
...
* [Modalità di Esegue i baking] Nuova modalità di esegue i baking dedicata alla esegue i baking
* [Modalità Eseguita i baking] Imposta scelta rapida da tastiera per passare alla modalità eseguita i baking su F8
* [Modalità di Esegue i baking] Pulsante Aggiungi inizio e Annulla esegue i baking nella finestra della vista
* [Modalità di Esegue i baking] Aggiungete una selezione eseguita i baking nell’elenco Set di texture
* [Modalità di Esegue i baking] Aggiungere una nuova finestra Baker mappa trama per selezionare i baker
* [Modalità di Esegue i baking] Aggiungere una nuova finestra Impostazioni mappa trama per modificare le impostazioni di esegue i baking
...
* [Modalità di Esegue i baking] Aggiungi parametri di esegue i baking e annulla le azioni nella finestra della cronologia
* [Modalità di Esegue i baking] Aggiungi breadcrumbs nelle impostazioni Mesh Map
* [Modalità di Esegue i baking] Aggiungere miniature di mappe trama nella finestra Baker mappe trama
* [Modalità di Esegue i baking] Aggiungi menu comprimibile delle impostazioni di visualizzazione nella finestra della vista 3D
* [Modalità Eseguita i baking] Aggiungi impostazione di visualizzazione per mostrare/nascondere la trama High-Poly
* [Modalità Eseguita i baking] Aggiungi impostazione di visualizzazione per mostrare/nascondere la trama della gabbia e il wireframe
* [Modalità Eseguita i baking] Aggiungi impostazione di visualizzazione per mostrare/nascondere la trama low-poly
* [Modalità di Esegue i baking] Aggiungi impostazione di visualizzazione per mostrare bordi netti senza giunture UV come errori
* [Modalità di Esegue i baking] Fornisci informazioni sulla trama nella finestra della vista e esegue i baking gli errori se Esegue i baking registro non è visibile
* [Modalità di Esegue i baking] Aggiungi azione per sincronizzare le impostazioni del baker tra tutti i set di texture

  Nella finestra Baker mappa trama, è possibile sincronizzare ciascun baker (e le impostazioni comuni) tra set di texture facendo clic sull’icona di collegamento accanto al nome del gruppo. Questa azione consente di aprire una finestra che consente di selezionare quali set di texture condivideranno gli stessi parametri.

* [Modalità di Esegue i baking] Aggiungi azioni per copiare e incollare le impostazioni del baker

  Nella finestra Baker mappa trama sono disponibili le azioni per copiare e superare le impostazioni di ciascun baker nei set di texture, tramite il menu dedicato nella parte superiore della finestra o il menu di scelta rapida (clic con il pulsante destro del mouse).

* [Modalità di Esegue i baking] Pulsante Aggiungi in Esegue i baking registro per passare da un errore alle impostazioni corrette
...
* [Scripting]&#x200B;[JavaScript] Aggiorna l’API in base ai nuovi parametri di esegue i baking
* [Scripting]&#x200B;[Python] Modulo di Esegue i baking: modifica parametri di esegue i baking
* [Scripting]&#x200B;[Python] Modulo di Esegue i baking: avvia/annulla esegue i baking
* Modulo di Esegue i baking [Scripting]&#x200B;[Python]: seleziona il metodo di curvatura
* [Scripting]&#x200B;[Python] Modulo di Esegue i baking: selezione di baker/riquadri uv
* [Scripting]&#x200B;[Python] Modulo di Esegue i baking: sincronizzare le impostazioni del baker tra tutti i set di texture
...
* [Import] Migliorare i tempi generali di importazione dei modelli 3D
  ...
  Abbiamo migliorato il tempo generale di importazione delle trame. Ad esempio, la riduzione del tempo di attesa durante il caricamento di trame a poli elevato per la esegue i baking. Questa ottimizzazione si applica in particolare al caricamento dei file OBJ.

<b>Corretto:</b>

* [Arresto anomalo] Cambiare i canali sul filtro con una pila specifica
* [Mac]&#x200B;[M1] Arresto anomalo durante la creazione di un livello di riempimento e l&#39;uscita dalla Pila livelli

  Questo problema può essere risolto eseguendo l’aggiornamento a Mac OS 13 (Ventura).

* [Scripting]&#x200B;[Python] Arresto anomalo di utilizzo di ui.add\_dock\_widget() con tipo errato
...
* Ricarica trama con una scelta rapida da tastiera da tastiera (CTRL+MAIUSC+R)
...
* Ripristina pittura pennello predefinito
...
* [Pannello Risorse] Le risorse preferite del &quot;Segnaposto&quot; vengono visualizzate nella parte superiore del pannello Risorse

  È stata aggiunta una nuova opzione di clic con il pulsante destro del mouse sulle risorse della libreria che consente di raggrupparle come segnaposti preferiti nella parte superiore del pannello. Puoi anche visualizzare tutte le tue risorse preferite tramite Ricerche salvate.
...
* [Win]&#x200B;[Eseguita i baking] Alcuni High-Poly non vengono caricati
...
* [Esporta] vista 2D esporta una mappa casualmente uniforme
...
* I Materiali avanzati [MacOS]&#x200B;[M1] non vengono visualizzati correttamente
...
* Esportare texture utilizzando il riempimento diffusione esegue il rendering delle mappe nere
* Il missaggio normale/Occlusione ambientale è interrotto
...
* [Shader]&#x200B;[ASM] Nuovo shader Adobe Standard Material
* [Shader]&#x200B;[ASM] Aggiunto il supporto per Anisotropia, Cancella pelo, Dispersione sottosuperficie, Specular edge color e Brillantezza
* [Shader]&#x200B;[ASM] Modificare i valori di colore dei canali predefiniti
* [Shader]&#x200B;[ASM]&#x200B;[Esporta] Modello di esportazione aggiornato da Adobe Dimension a Adobe Substance 3D Stager
* [Shader]&#x200B;[ASM] Etichette e descrizioni comandi aggiunte per i parametri di shader e MDL
* [Shader]&#x200B;[ASM] Rendete visibile il colore della Dispersione nel vista 2D anche se SSS non è supportato
* [Shader]&#x200B;[ASM]&#x200B;[Iray] Supporta lo shader ASM in Iray con la nuova MDL
* [Shader]&#x200B;[ASM]&#x200B;[Iray] Scattering sottosuperficie aggiornato in lucido e patinato nelle specifiche PBR legacy
* [Shader]&#x200B;[ASM]&#x200B;[Content] Ha modificato il tipo SSS predefinito per i campioni
* [Shader]&#x200B;[ASM] Documentazione aggiunta per l&#39;API ASM
* [Shader]&#x200B;[ASM] Ottimizzate gli ombreggiatori per ignorare i canali inutilizzati
* [Shader] Esporre i nuovi canali del set di texture
* [Shader] Miglioramento della dispersione sottosuperficie
...
* [Arresto anomalo] Mancata corrispondenza del nome tra l&#39;elenco e l&#39;Esportazione del set di texture
* [Arresto anomalo]&#x200B;[Librerie] Fai doppio clic su una sub-libreria
...
* [Libraries]&#x200B;[Contenuto] Il filtro Ambiente luce Eseguita i baking è nero per impostazione predefinita
* [Linux]&#x200B;[MacOS]&#x200B;[Esporta mesh] Impossibile importare glTF creato su Linux/MacOS
* [Linux] Il trascinamento di un file nel pannello Risorse può provocare un arresto anomalo
* [Srotolamento automatico] Lo Srotolamento automatico è disponibile anche se non è stata selezionata una trama per il ricaricamento
...
* [Arresto anomalo]&#x200B;[Motore] Arresto anomalo quando si tenta di cancellare e sostituire i canali esistenti
* [Arresto anomalo] Modifica dello shader dopo aver colorato una maschera in livelli di materiale
* [Arresto anomalo]&#x200B;[Motore] Arresti anomali con alcuni progetti pesanti
* [Baker] La corrispondenza per nome non funziona con l’OBJ esportato da zBrush
* Le Texture [Spostamento]&#x200B;[SVT] non vengono visualizzate all’apertura del progetto quando lo spostamento è attivo
...
* [Pila livelli]&#x200B;[UI] Aggiungi l’icona &quot;i&quot; quando un livello alfa è corretto dal gamma
...
* [Scelta rapida da tastiera] Aggiungi Ctrl+Maiusc+B per aprire la finestra di Esegue i baking
* [UI]&#x200B;[Menu] Aggiungi voce nel menu &quot;Modifica&quot; per aprire la finestra di Esegue i baking
...
* [Content] Integrare 3 nuovi filtri (MatFx): fumetto, acquerello, Pittura a olio (ispirato al lavoro di Emrecan Cubukcu)
* [Contenuto] Integra 102 pennelli predefiniti di Photoshop dai pacchetti di Kyle T. Webster
* [Contenuto] Integra 18 nuovi predefiniti pennello: Pittura freccia a rullo, Pittura testo avviso rullo, Carboncino fine e altri ancora
* [Contenuto] Integra 9 nuove alfa: rullo Pittura del Brush Maker, Photoshop del Brush Maker, pattern di pennelli e altro ancora
...
* [Esporta] Esporta texture in Sketchfab senza perdere la qualità delle mappe normali
...
* arresto anomalo [Esporta] durante l’esportazione di una texture normale o di occlusione non valida
...
* [Shelf] 9 Nuovi filtri (MatFx Detail Edge Wear, Blocca, HBAO, ecc.)
...
* [Finestra vista] Il colore interno del piano della Simmetria non è più visibile
...
* [Ombreggiatori] Avvertenza sul test alfa con lo shader predefinito
...
* [Baker] Arresto anomalo quando si esegue i baking con trame specifiche

**Problemi noti:**

* [Mac] In alcuni casi, le particelle possono causare il danneggiamento delle texture
...
* [Strumento] Artefatti di nero quando si utilizza lo strumento sfumino
* [Baker] Il Eseguo i baking non riesce se si utilizza Corrispondenza per nome con una gabbia
* [Baker] Occlusione ambientale interrotta quando si esegue i baking solo con Mappa normale
...
* [Riquadro di visualizzazione] Problema di dithering in vista 3D su MacOS
* [Finestra vista] Le anteprime delle particelle non vengono visualizzate correttamente quando il profilo colore è attivato
* [Iray] Arresto anomalo di passaggio del progetto a OpenGL in caso di errore di inizializzazione di Iray
* [IRay] La Lucentezza viene ignorata durante il rendering di SpecGloss shader/mdl
* [Shader] Lo shader delle specifiche/lucido non corrisponde a Iray e SD
...
* [Livelli] Il metodo di fusione &quot;mappa normale dettagli invertiti&quot; non funziona sui canali in scala di grigio
...
* [Baker] Consenti di eseguire i baking texture 8K
* [Baker] Consente di eseguire i baking risoluzioni non quadrate
* [Baker] Migliora il consumo di memoria quando si eseguono i baking trame pesanti ad alto polio
...
* [Scaffale] Nuovo contenuto : nuovi filtri (Trasforma, specchio, triplanari, ecc.)
...
* [Shelf] Il filtro HSL è stato migliorato per semplificare l&#39;uso degli artisti
* [Shader] Aggiungi il supporto per il canale di specular level negli shader PBR
* [Shader] Supporto per il dithering nello shader di test Alpha
* [Shader] Aggiunta del supporto per la mappatura delle occlusioni parallasse negli shader PBR
* [Shader] Consente di definire un&#39;interfaccia utente personalizzata per i parametri di shader
...
* [Scripting] Consente di recuperare i parametri di shader come JSON.
* [Scripting] Aggiunta del supporto per le connessioni WebSocket
* [Scripting] Aggiungi la possibilità di caricare istanze shader
...
* [Finestra vista] Aggiungere la mappa normale composta (normale+height+esegue i baking) alla modalità Solo
...
* [Scripting] Aggiungere esempi nella documentazione di esegue i baking
...
* [Baker] La corrispondenza per nome ora utilizza il suffisso come separatore
...
* [Baker] L’opzione Esegue i baking corrispondenza per nome non funziona
* [Baker] Lo spazio tangente Mikk utilizzato in SP non funziona con UE4
* [Baker] Il baker ID non può eseguire i baking colori ID materiale
* [vista 2D] Il Wireframe non viene visualizzato quando si utilizza lo strumento decalcomania Geometria
* [Strumento] Il canale alfa di pennelli viene visualizzato come controllo anziché come trasparenza con i materiali
* [Strumento] Arresto anomalo con decalcomania geometria
* [Livelli] Lo slot del materiale è compresso per impostazione predefinita sul livello di riempimento
* arresto anomalo [Esporta] quando l’esportazione viene eseguita con dimensioni superiori alla risoluzione impostata per la texture
