...
breadcrumb-title: ''
description: Scoprite come utilizzare la gestione del colore OpenColorIO in Substance 3D Painter per flussi di lavoro di colore coerenti tra le pipeline.
...
Questa pagina elenca le impostazioni di gestione del colore relative all’OpenColorIO (OCIO).
...
| **substance\_3d\_painter\_bitmap\_import\_floating** | Ruolo per specificare lo spazio cromatico utilizzato per importare le immagini HDR. |
...
| **substance\_3d\_painter\_bitmap\_export\_8bit** | Ruolo per specificare lo spazio colore utilizzato per l’esportazione di texture a 8 bit. |
