...
<b>Substance 3D Painter 9.1</b> aggiunge il controllo della tangente per lo strumento tracciato, il supporto del formato di file SVG, la possibilità di importare e applicare risorse mediante trascinamento e il supporto per traslucidità nella finestra della vista.
...
### Nuovo supporto per traslucidità, trasparenza e assorbimento nella finestra della vista

![ASM banner](../assets/v91_banner_asm.jpg)

Lo shader <b>Adobi Standard Material</b> (ASM), che è l&#39;impostazione predefinita durante la creazione di un nuovo progetto, è stato aggiornato per supportare le proprietà <b>Traslucidità</b>, <b>Trasparenza</b> e <b>Assorbimento</b>. Ciò significa che ora è possibile visualizzare il risultato di tali comportamenti di rendering nella finestra della vista in tempo reale (nonché all’interno del modulo di rendering Iray).
...
* <b>Nuove impostazioni shader ASM</b>
  ...
  * <b>Traslucidità</b>: questa nuova proprietà consente di creare superfici come vetro, rendendo le forme trasparenti mantenendo i riflessi degli specular. Per utilizzarlo, aggiungi un canale Traslucidità nel progetto e abilita il parametro <b>Traslucidità</b> nel gruppo <b>Interior</b>.
...
* <b>Interfaccia utente e descrizioni comandi migliorate per le impostazioni di shader</b>
...
* <b>Nuovo progetto di esempio per la dimostrazione dell&#39;Adobe Standard Material</b>
...
* <b>Traslucidità canale ora è impostato su un colore nero per impostazione predefinita</b>

  Per semplificare l&#39;utilizzo delle nuove proprietà di shader ed evitare risultati imprevisti nella finestra della vista, il colore predefinito della Traslucidità dei canali è stato cambiato in nero (anziché in bianco).

  Se questo canale era già in uso nel progetto, puoi ottenere il comportamento precedente semplicemente aggiungendo un livello di riempimento nella parte inferiore della Pila livelli e impostando il valore del canale su bianco. È possibile attivare l&#39;impostazione <b>Usa traslucidità come maschera di dispersione</b> nel parametro shader per riapplicare il contributo del canale al risultato della dispersione della superficie inferiore.

### Nuovo supporto per file grafica vettoriale (SVG)

![Banner SVG](../assets/v91_banner_svg.jpg)

Questa versione aggiunge il supporto dei file SVG come risorse utilizzabili nei livelli, negli strumenti di pittura e così via.
...
* <b>Importare file SVG</b>\
  ...
  Anche in questa versione l’importazione è stata facilitata (vedi di seguito), in modo che i file SVG possano essere utilizzati semplicemente trascinando e rilasciando le risorse dall’esterno di Painter direttamente nella trama o nella Pila livelli.
...
* <b>Nuovi materiali su misura per SVG</b>
  ...
  * <b>Pittura spray personalizzata</b>: consente di simulare una decalcomania dipinta su una parete a partire da una singola immagine di input.
...
* <b>Importa mediante trascinamento nella Pila livelli</b>\
  Allo stesso modo è possibile rilasciare file di risorse esterne nella finestra della vista, rilasciando i file nella Pila livelli è possibile creare direttamente livelli o effetti con la risorsa in essa contenuta.
...
* <b>Trascina molti tipi di risorse</b>
  ...
  È ora possibile trascinare i tipi di risorse direttamente nella finestra della vista o nella Pila livelli. Il seguente tipo di risorse può ora essere trascinato e rilasciato (quasi) ovunque:
...
* <b>Rilascia le risorse come nuovo livello o effetto</b>
  ...
  ![Trascina Pila livelli](../assets/v91_drop_filter_stack.gif)
...
* <b>Rilasciare nella finestra della vista per creare nuovi livelli</b>
  ...
  Nella finestra della vista è possibile anche trascinare e rilasciare le risorse per creare nuovi livelli. A seconda del tipo di risorsa, il risultato potrebbe cambiare. Un filtro crea un livello di pittura in modalità passthrough, mentre una maschera avanzata crea un livello di riempimento con una nuova maschera.

  ![Trascinare la maschera avanzata](../assets/v91_drop_smart_mask.gif)
...
* <b>Nuovo set UV in modalità di proiezione riempimento con impostazione UV</b>
  ...
  È stata aggiunta una nuova modalità di proiezione per livelli/effetti di riempimento denominata <b>UV impostato su proiezione UV impostata</b>. Può essere utilizzato per proiettare una texture basata su diversi UV disponibili sulla trama all&#39;interno del progetto. Può essere utilizzato per trasferire le texture in modo più avanzato, senza dover ricorrere a strumenti esterni.
...
* <b>Nuovi miglioramenti per l’API Python</b>
  ...
  * Il percorso della texture di esportazione del progetto ora può essere recuperato anche dall’API.
