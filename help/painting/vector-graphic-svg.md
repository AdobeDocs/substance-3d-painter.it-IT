...
Quando si modifica l’ambito di una grafica vettoriale (vedere l’impostazione precedente), viene visualizzata una finestra con un elenco di elementi da selezionare per specificare cosa includere o escludere dall’immagine finale renderizzata.
