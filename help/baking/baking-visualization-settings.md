...
helpx_learn_topic: ""
helpx_tags: ""
title: Eseguire i baking le impostazioni di visualizzazione
...
# Eseguire i baking le impostazioni di visualizzazione

![](../assets/viewport-vizu.png)

La visualizzazione Eseguita i baking è un pannello all&#39;interno del riquadro di visualizzazione di Painter in modalità di Esegue i baking. Consente di regolare le impostazioni relative alla visualizzazione delle trame nella finestra della vista.

## Impostazioni generali

| Impostazione | Descrizione |
| --- | --- |
| **Nascondi trame eseguite i baking** | Se attivata, questa icona nasconderà il poly alto e la mesh della gabbia nella finestra della vista. <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r1-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="../assets/hide-baking-meshes.png"/></div> |
...
| Impostazione | Descrizione |
| --- | --- |
| <b>Cuciture mancanti sui bordi rigidi</b> | Se attivata, gli spigoli netti sulla superficie della trama che non sono giunture UV verranno evidenziati con il colore definito dal pulsante accanto all&#39;impostazione. I bordi evidenziati sono visibili solo sulla gabbia e sulla trama a basso poli. I bordi sono visibili sia nella vista 2D che 3D. Questa impostazione consente di identificare gli spigoli con normali di vertice divisi senza una giuntura di apertura UV, che potrebbe provocare problemi di esegue i baking in seguito. |
...
<td> </td>
<td><p>Se questa opzione è attivata, nel riquadro di visualizzazione saranno visibili le trame a basso poli su cui sono eseguite i baking le trame a elevato poli. Se è abilitata l'opzione <b>Nascondi trame eseguite i baking</b>, anche questa impostazione viene attivata automaticamente per evitare che la finestra della vista sia vuota.</p>
...
<td><b>Qualità</b></td>
<td>Controlla la qualità del riflesso dello specular sulla superficie della trama a basso poli. Un valore elevato garantirà una maggiore fedeltà nelle riflessioni, ma può influire anche sulle prestazioni. Un valore basso può introdurre giunture nell’ombreggiatura con le mappe normali (Nota: questo è solo un problema di visualizzazione).</td>
...
<td>Controlla in che misura l’Occlusione ambientale eseguita i baking contribuisce all’ombreggiatura della trama a basso poli nella finestra della vista.</td>
</tr><tr><td><b>Normale con curvatura</b></td>
<td>Se questa opzione è attivata, utilizzare Normali incurvate eseguite i baking per migliorare l’ombreggiatura della trama a basso poli nella finestra della vista.</td>
</tr><tr><td><b>Quantità curvatura diffuse della normal</b></td>
<td>Controlla l'effetto delle Normali incurvate sull'ombreggiatura della diffusione.</td>
</tr><tr><td><b>Quantità curvatura della specular della normal</b></td>
<td>Controlla l’entità dell’influenza della Normali incurvate sull’ombreggiatura dello specular.</td>
</tr></tbody></table>
