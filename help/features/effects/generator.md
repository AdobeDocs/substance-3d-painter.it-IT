...
1. Nel **pannello Livelli**, fate clic con il pulsante destro del mouse sulla maschera.
1. Selezionare **Aggiungi generatore**.
1. Quando la maschera è selezionata, il generatore viene visualizzato sotto il livello nel **pannello Livelli**.
1. Con il generatore selezionato, nel **pannello Proprietà** fate clic sul pulsante **Generatore** per selezionare il generatore specifico da applicare.

Per aggiungere un generatore a un livello:

1. Fate clic con il pulsante destro del mouse sul livello.
1. Selezionare **Aggiungi generatore**.
1. Il generatore viene visualizzato sotto il livello nel **pannello Livelli**.
1. Con il generatore selezionato, nel **pannello Proprietà** fate clic sul pulsante **Generatore** per selezionare il generatore specifico da applicare.

>[!NOTE]
>
> È possibile applicare generatori, filtri o altri effetti a un determinato livello o alla relativa maschera. Quando selezioni un livello, i suoi effetti saranno visibili sotto il livello. Per visualizzare gli effetti applicati alla maschera, selezionate la maschera anziché solo il livello.
...
>[!NOTE]
>
> Quando crei una nuova sostanza in Substance 3D Designer, puoi scegliere il **modello Painter Generator** per ottenere un buon punto di partenza per il nuovo generatore.
