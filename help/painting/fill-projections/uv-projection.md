...
breadcrumb-title: ''
description: Utilizzate la Proiezione UV in Substance 3D Painter per proiettare la texture in base alle coordinate UV per un posizionamento preciso della texture.
...
| --- | --- |
| **Filtraggio** | Controlla il modo in cui la texture o il materiale verranno filtrati. Queste impostazioni possono influire sull’aspetto della texture se vengono ripetute più volte. Con valori di ridimensionamento elevati, l’utilizzo di un metodo di filtraggio diverso da quello predefinito può produrre risultati migliori. Impostazioni attualmente disponibili:<ul data-preserve-html="true"><li data-preserve-html="true"><strong>Sede centrale </strong> bilineare `\|`: (impostazione predefinita) Filtro bilineare avanzato che tenta di migliorare la qualità della texture quando i valori Affiancamenti sono elevati.</li><li data-preserve-html="true"><strong>Bilineare `\|` Nitido </strong>: filtro bilineare semplice che smussa leggermente la texture ma tenta di mantenere i dettagli.</li><li data-preserve-html="true"><strong>Più vicino a </strong>: nessun filtro utile se il filtro bilineare produce un risultato sfocato e interrompe i dettagli più fini. Può introdurre l&#39;alias nella texture.</li></ul> |
...
| <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table1_row-r2-column-c0_image" src="../../assets/icon-manipulator-settings-2d.png" width="50px"/></div> | Dimensioni maniglie manipolatore | Questo menu contiene tre impostazioni che definiscono la dimensione delle maniglie del Trasforma nella finestra della vista:<ul data-preserve-html="true"><li data-preserve-html="true"><strong>Piccolo</strong></li><li data-preserve-html="true"><strong>Medio</strong></li><li data-preserve-html="true"><strong>Grande</strong></li></ul> |
