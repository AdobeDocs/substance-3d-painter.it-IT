...
helpx_learn_topic: ""
helpx_tags: ""
title: Le finestre di visualizzazione e le texture sono sfocate o poco nitide
...
# Le finestre di visualizzazione e le texture sono sfocate o poco nitide
...
Le finestre delle viste utilizzano mipmap e filtri di texture per consentire lo streaming in entrata e in uscita di [Texture virtuali sparse](../../../features/sparse-virtual-textures.md) al fine di migliorare le prestazioni. In alcuni casi, questo può portare a texture sfocate.

Il filtro delle texture può essere regolato tramite la finestra Impostazioni schermo sotto i parametri [Impostazioni finestra vista](../../../interface/display-settings/viewport-settings.md).
