...
La Proiezione sferica di riempimento consente di proiettare immagini e pattern attorno a un oggetto. Può essere utile proiettare su oggetti arrotondati o distorcere la texture in pattern circolari.
...
| *Impostazione* | *Descrizione* |
| --- | --- |
| **Scala** | Definite quante volte la texture si ripeterà all&#39;interno della proiezione. |
| **Rotazione** | Controllate l&#39;angolo della texture applicata alla proiezione. |
| **Scostamento** | Consente di controllare l’origine della texture proiettata. Il valore di default indica che la texture si trova al centro della proiezione. |
