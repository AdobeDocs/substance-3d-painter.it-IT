...
>[!NOTE]
>
> Substance 3D Painter genera **colori HDR** (High dynamic range) (in uno spazio gamma lineare), ma la maggior parte delle schermate consente solo di visualizzare **colori LDR** (basso intervallo dinamico). Per mappare l&#39;intervallo HDR all&#39;intervallo LDR, è necessario effettuare una conversione. Questo è il principio della mappatura dei toni.
