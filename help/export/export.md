...
breadcrumb-title: ''
description: Scoprite come esportare le texture da Substance 3D Painter in vari formati per utilizzarle in altre applicazioni e motori di gioco.
...
Le texture vengono esportate come una raccolta di bitmap. Painter offre molta flessibilità durante l’esportazione delle texture grazie ai Modelli di output. I modelli di output consentono di controllare aspetti quali la denominazione dei file esportati, il modo in cui le texture vengono compresse nei canali e il formato e la profondità di bit dei file esportati. Se il problema persiste, Painter include decine di Modelli di output predefiniti configurati per le applicazioni e i casi d&#39;uso 3D più comuni.

Aprite la <b>finestra Esporta</b> e iniziate a esportare le texture con <b>File > Esporta texture</b> oppure usate la scelta rapida da tastiera <b>CTRL + MAIUSC + E</b>. Utilizzate i seguenti collegamenti per ulteriori informazioni sull’esportazione delle texture:
